        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4 text-sm font-medium">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <br />
                  <a href="mailto:support@anterrastriyakisanunion.com" className="text-green-700 dark:text-green-400 font-bold hover:underline text-sm">internationalkisanunion@gmail.com</a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-2xl">📞</span>
          ...
          <div className="bg-white/70 dark:bg-base-900/70 backdrop-blur-sm border border-white/40 dark:border-white/10 rounded-[2rem] p-6 shadow-xl">
            ...
            <div className="flex flex-wrap gap-2">
              <a href="https://www.facebook.com/share/v/1E2ueFmbUR/" target="_blank" rel="noopener noreferrer" className="btn btn-sm bg-base-100/50 dark:bg-base-900/50 border border-base-300/30 gap-2 font-bold hover:bg-blue-100 hover:text-blue-700 hover:border-blue-300 rounded-xl transition-all">
              ...
              <a href="https://www.instagram.com/reel/DbA4bC2E6d5/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" target="_blank" rel="noopener noreferrer" className="btn btn-sm bg-base-100/50 dark:bg-base-900/50 border border-base-300/30 gap-2 font-bold hover:bg-pink-50 hover:text-pink-600 hover:border-pink-300 rounded-xl transition-all">
              ...
              <a href="https://youtu.be/oKzNRg3Zxtg" target="_blank" rel="noopener noreferrer" className="btn btn-sm bg-base-100/50 dark:bg-base-900/50 border border-base-300/30 gap-2 font-bold hover:bg-red-100 hover:text-red-600 hover:border-red-300 rounded-xl transition-all">
