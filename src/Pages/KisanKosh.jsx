        ...
        <div className="relative rounded-[2rem] overflow-hidden border border-base-300 shadow-2xl">
          ...
          <div className="relative z-10 p-8 sm:p-14 lg:p-20">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/15 border border-primary/30 mb-6">
              ...
              <span className="text-[11px] font-bold text-slate-100 tracking-[0.15em] uppercase">{t.kosh.koshBadge || 'किसान कोष'}</span>
            </div>

            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-100 leading-[1.15] mb-6 max-w-3xl">
              {t.kosh.koshTitle || 'हम एक किसान कोष का निर्माण करेंगे'}
            </h1>

            <p className="text-base sm:text-lg text-slate-300 leading-relaxed max-w-3xl mb-8">
              {t.kosh.koshDesc || 'सिर्फ विश्व के गरीब किसान और मजदूरों को आर्थिक सहायता प्रदान करने के लिए — ताकि कोई भी किसान भूखा न सोए, कोई भी मजदूर असहाय न रहे।'}
            </p>
        ...
        <div>
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-accent/10 border border-accent/20 mb-4">
              <span className="text-[11px] font-bold text-accent tracking-[0.15em] uppercase">{t.kosh.demandsBadge || 'हमारी माँगें'}</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight mb-3">
              {t.kosh.demandsTitle || 'किसानों को क्या चाहिए?'}
            </h2>
            <p className="text-sm text-base-content/50 max-w-xl mx-auto leading-relaxed">
              {t.kosh.demandsSubtitle || 'बड़े-बड़े वादे नहीं, आधुनिक तकनीक और खेती के संसाधन चाहिए, तभी खेत और देश दोनों समृद्ध होंगे।'}
            </p>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              { icon: '🌱', label: t.kosh.demand1 || 'समय पर खाद', color: 'from-green-500/20 to-green-600/5', border: 'hover:border-green-500/40', iconBg: 'bg-green-500/15' },
              { icon: '⚡', label: t.kosh.demand2 || 'बिजली', color: 'from-yellow-500/20 to-yellow-600/5', border: 'hover:border-yellow-500/40', iconBg: 'bg-yellow-500/15' },
              { icon: '💧', label: t.kosh.demand3 || 'पानी', color: 'from-blue-500/20 to-blue-600/5', border: 'hover:border-blue-500/40', iconBg: 'bg-blue-500/15' },
              { icon: '⛽', label: t.kosh.demand4 || 'सस्ता पेट्रोल-डीजल', color: 'from-orange-500/20 to-orange-600/5', border: 'hover:border-orange-500/40', iconBg: 'bg-orange-500/15' },
              { icon: '🚜', label: t.kosh.demand5 || 'आधुनिक तकनीक', color: 'from-purple-500/20 to-purple-600/5', border: 'hover:border-purple-500/40', iconBg: 'bg-purple-500/15' },
            ].map((item, i) => (
              <div
                key={i}
          ...
          <div className="mt-8 text-center">
            <div className="inline-block bg-base-200/50 border border-base-300 rounded-2xl px-8 py-5 max-w-2xl">
              <p className="text-sm sm:text-base font-bold italic text-base-content/70 leading-relaxed">
                "{t.kosh.philosophyQuote || 'किसानों को बड़े-बड़े वादे नहीं, आधुनिक तकनीक और खेती के संसाधन चाहिए, तभी खेत और देश दोनों समृद्ध होंगे।'}"
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative rounded-[2rem] overflow-hidden border border-base-300 shadow-2xl">
          ...
          <div className="relative z-10 p-8 sm:p-14 lg:p-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/15 border border-primary/30 mb-6">
                  <span className="text-[11px] font-bold text-slate-100 tracking-[0.15em] uppercase">{t.kosh.gramBadge || 'संगठन का आधार'}</span>
                </div>

                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-100 leading-[1.15] mb-6">
                  {t.kosh.gramTitle || 'ग्राम इकाई ही'}<br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-secondary">
                    {t.kosh.gramTitleHighlight || 'संगठन का आधार है'}
                  </span>
                </h2>

                <p className="text-base text-slate-300 leading-relaxed mb-6">
                  {t.kosh.gramDesc1 || 'जब गाँव मज़बूत होंगे, तभी संगठन मज़बूत होगा।'}
                </p>

                <p className="text-base text-slate-300 leading-relaxed">
                  {t.kosh.gramDesc2 || 'हर किसान की भागीदारी, हर ग्राम इकाई की एकता — यही संगठन की ताक़त है।'}
                </p>
              </div>
              ...
              <div className="space-y-4">
                {[
                  {
                    num: '01',
                    title: t.kosh.gramP1Title || 'गाँव की मज़बूती',
                    desc: t.kosh.gramP1Desc || 'ग्राम स्तर पर संगठन को मजबूत करने का प्रयास करें। हर गाँव को एक इकाई बनाकर किसानों को एकजुट करें।',
                    color: 'primary'
                  },
                  {
                    num: '02',
                    title: t.kosh.gramP2Title || 'हर किसान की भागीदारी',
                    desc: t.kosh.gramP2Desc || 'कोई भी किसान छोटा या बड़ा नहीं होता — सबकी भागीदारी बराबर है। सबकी आवाज़ सुनी जाएगी।',
                    color: 'accent'
                  },
                  {
                    num: '03',
                    title: t.kosh.gramP3Title || 'एकता ही ताकत',
                    desc: t.kosh.gramP3Desc || 'अकेला किसान कमज़ोर है, लेकिन गाँव की एकजुट इकाई अजेय है। यही हमारी शक्ति का स्रोत है।',
                    color: 'secondary'
                  },
                ].map((p, i) => (
                  <div
          ...
          <div className="group relative bg-base-200/40 backdrop-blur-sm border border-base-300 rounded-[2rem] shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 overflow-hidden p-6 sm:p-8">
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 mb-6">
                <span className="text-[10px] font-bold text-primary tracking-[0.15em] uppercase">{t.kosh.scopeBadge || 'संगठन प्रोफ़ाइल'}</span>
              </div>
              <h3 className="text-xl font-black text-primary mb-6 tracking-tight">{t.kosh.scopeHeading}</h3>
              <div className="space-y-4">
                {[
                  { label: t.kosh.labelName, value: t.kosh.valueName, valueColor: 'text-accent' },
                  { label: t.kosh.labelScope, value: t.kosh.valueScope, valueColor: 'text-base-content' },
                  { label: t.kosh.labelOffice, value: t.kosh.valueOffice, valueColor: 'text-base-content' },
                ].map((row, i) => (
          ...
          <div className="group relative bg-base-200/40 backdrop-blur-sm border border-base-300 rounded-[2rem] shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 overflow-hidden p-6 sm:p-8">
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent/10 border border-accent/20 mb-6">
                <span className="text-[10px] font-bold text-accent tracking-[0.15em] uppercase">{t.kosh.resBadge || 'संकल्प'}</span>
              </div>
              <h3 className="text-xl font-black text-accent mb-6 tracking-tight">{t.kosh.resolutionHeading}</h3>
              <ul className="space-y-5">
                {[
                  { text: t.kosh.res1, color: 'primary' },
                  { bold: t.kosh.res2Bold, text: t.kosh.res2Text, color: 'accent' },
                  { text: t.kosh.res3, color: 'primary' },
                ].map((item, i) => (
          ...
          <div className="relative z-10 p-8 sm:p-14 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-left max-w-2xl">
              <h2 className="text-2xl sm:text-3xl font-black text-base-100 mb-3">
                {t.kosh.ctaTitle || 'ग्राम स्तर पर संगठन को मजबूत करने का प्रयास करें'}
              </h2>
              <p className="text-sm sm:text-base text-base-100/80 leading-relaxed">
                {t.kosh.ctaDesc || 'अपने गाँव की ग्राम इकाई बनाएं, किसानों को जोड़ें, और इस आंदोलन को धरती की ज़मीन से मज़बूत करें।'}
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
              <a href="/gram-unit" className="btn btn-neutral text-slate-100 btn-md sm:btn-lg shadow-lg hover:scale-[1.03] active:scale-[0.98] transition-transform duration-200">
                {t.kosh.ctaBtn1 || 'ग्राम इकाई बनाएं'}
              </a>
